...
export const plates: Plate[] = [
  { file: 'art-07.jpg', col: '2 / span 6', alt: 'Two hands reaching upward toward a golden sun, wrapped in ribbons of colored light' },
  { file: 'art-01.jpg', col: '9 / span 4', alt: 'Three hands meeting, with water pouring over them, drawn on toned paper' },
  { file: 'art-03.jpg', col: '1 / span 5', alt: 'Graphite portrait of an older man in a collared shirt, looking off to one side' },
  { file: 'art-05.jpg', col: '7 / span 5', alt: 'Graphite portrait of a young woman with long dark hair and a turtleneck' },
  { file: 'art-02.jpg', col: '3 / span 8', alt: 'Still life in acrylic: a blue kettle, a plate of apples, a wine bottle and a champagne glass on draped cloth' },
  { file: 'art-09.jpg', col: '2 / span 5', alt: 'A dolphin leaping in front of a red sun above cresting stylized waves' },
  { file: 'art-06.jpg', col: '8 / span 4', alt: 'A pelican rising from choppy water with its wings spread wide' },
  { file: 'art-08.jpg', col: '1 / span 4', alt: 'A rooster-headed figure in Renaissance courtly dress, standing on a patterned carpet in a palace interior' },
  { file: 'art-04.jpg', col: '6 / span 7', alt: 'Two animal-headed figures in hats and overcoats playing cards at a table, after Cezanne' },
